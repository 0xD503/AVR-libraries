...
#define TWBR_VALUE ((F_CPU / SCL_FREQUENCY) - 16) / (2 * PRESCALER);		// Calculating TWBR value
...
#define I2C_TRANSMISSION_BUFFER_SIZE 9										// Set this to the largest message size that will be sent including address byte.
#define I2C_RECEPTION_BUFFER_SIZE 9
