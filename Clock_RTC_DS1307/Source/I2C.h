...
#define I2C_TRANSMISSION_BUFFER_SIZE 11										// Set this to the largest message size that will be sent including address byte.
#define I2C_RECEPTION_BUFFER_SIZE 11
